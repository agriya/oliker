...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        eslint: {
            src: [
          '<%= yeoman.app %>/scripts/**/*.js', "!<%= yeoman.app %>/scripts/**/default.cache.js", "!<%= yeoman.app %>/scripts/**/template.js"
        ]
        },
        ...
        jsbeautifier: {
            ...
            app: {
                src: ['Gruntfile.js', '<%= yeoman.app %>/**/*.js', '<%= yeoman.app %>/**/*.html', "!<%= yeoman.app %>/ng-admin/**/*.*"]
            },
            'pre-merge': {
                src: ['<%= yeoman.app %>/**/*.js', "!<%= yeoman.app %>/ag-admin/scripts/admin.cache.js", "!<%= yeoman.app %>/ng-admin/**/*.*"],
                options: {
                    mode: 'VERIFY_ONLY'
                }
            }
