...
/**
 * @ngdoc function
 * @name olikerApp.controller:PageViewController
 * @description
 * # PageViewController
 * Controller of the olikerApp
 */
angular.module('olikerApp')
    .controller('PageViewController', function($rootScope, $stateParams, PageFactory, flash, $filter) {
        var vm = this;
        var params = {};
        params.id = $stateParams.id;
        PageFactory.get(params, function(response) {
