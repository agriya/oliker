...
/**
 * @ngdoc function
 * @name olikerApp.controller:ContactController
 * @description
 * # ContactController
 * Controller of the olikerApp
 */
angular.module('olikerApp')
    .controller('ContactController', function($rootScope, ContactsFactory, flash, vcRecaptchaService, $filter) {
        var vm = this;
        ...
        vm.save = function() {
            ...
            if (vm.contactForm.$valid && !vm.save_btn) {
                vm.save_btn = true;
                ContactsFactory.create(vm.contact, function(response) {
